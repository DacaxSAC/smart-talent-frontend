...
export const RequestsHistoryList = ({
  requestsHistory,
}: Readonly<RequestsHistoryListProps>) => {
  ...
  return (
    <div className="w-full text-[12px] font-karla font-light">
      ...
      <div className="overflow-x-auto">
        <div
          className="min-w-max px-2 grid gap-0 bg-main-3plus dark:bg-main-1plus text-black dark:text-white rounded-sidebar mb-4"
      ...
      {/* Filas */}
      <div className="text-black dark:text-white flex flex-col gap-2 overflow-x-auto">
        {requestsHistory.map((request) => (
          <div key={request.id} className="min-w-max">
            <div
              className="px-2 grid gap-0 border border-white-1 dark:border-black-1 rounded-sidebar hover:bg-black-05 dark:hover:bg-white-10"
              style={{ gridTemplateColumns: columnTemplate }}
            >
              ...
              <div className="col-span-1 p-2">{request.owner}</div>
              <div className="col-span-1 p-2">{request.dni}</div>
              <div className="col-span-1 p-2">{request.fullname}</div>
              <div className="col-span-1 p-2">
                <span
